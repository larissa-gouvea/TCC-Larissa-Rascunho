...
entity frontend_slave is
    port(
        ...
        ARESETn: in std_logic;
            ...
            --AWID   : out std_logic_vector(4 downto 0);
            --AWADDR : out std_logic_vector(63 downto 0);
            --AWLEN  : out std_logic_vector(7 downto 0) := (others => '0');
            --AWSIZE : out std_logic_vector(2 downto 0) := std_logic_vector(to_unsigned(32 / 8, 3)); -- valor 100 pois 32/8=4 e 4 em binário é 100(3 bits)
            ...
            --BID    : in std_logic_vector(4 downto 0) := (others => '0');
            --BRESP  : in std_logic_vector(2 downto 0) := (others => '0');

            -- Read request signals.
            --ARVALID: out std_logic;
            --ARREADY: in std_logic;
            --ARID   : out std_logic_vector(4 downto 0) := (others => '0');
            --ARADDR : out std_logic_vector(63 downto 0) := (others => '0');
            --ARLEN  : out std_logic_vector(7 downto 0) := (others => '0');
            --ARSIZE : out std_logic_vector(2 downto 0) := std_logic_vector(to_unsigned(32 / 8, 3));
            ...
            --RLAST  : in std_logic;
            --RID    : in std_logic_vector(4 downto 0) := (others => '0');
            --RRESP  : in std_logic_vector(2 downto 0) := (others => '0');
        ...
        --o_STATUS_SEND: out std_logic_vector(2 downto 0);
        ...
        i_ADDRESS_RECEIVE: in std_logic_vector(31 downto 0);
